...
namespace _1282
{
    ...
    internal static class Program
    {
        ...
        {
            Assert.Equal(GroupThePeople(new[] {3, 3, 3, 3, 3, 1, 3}), new List<IList<int>>
            {
                new List<int> {0, 1, 2},
                new List<int> {5},
                new List<int> {3, 4, 6}
            ...
            Assert.Equal(GroupThePeople(new[] {2, 1, 3, 3, 3, 2}), new List<IList<int>>
            {
                new List<int> {1},
                new List<int> {2, 3, 4},
                new List<int> {0, 5},
        ...
        private static IList<IList<int>> GroupThePeople(int[] groupSizes)
        {
            ...
            for (var i = 0; i < groupSizes.Length; i++)
            {
                ...
                else sizes.Add(groupSizes[i], new List<int> {i});
            }
